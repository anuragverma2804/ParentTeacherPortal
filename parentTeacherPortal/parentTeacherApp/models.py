...
class StudentProfile(models.Model):
    ...
    student_school = models.ForeignKey('SchoolProfile', related_name='Student_School', null=True, default=None, blank=True,
...
class TeacherProfile(models.Model):
    ...
    teacher_school = models.ForeignKey('SchoolProfile', related_name='Teacher_School', null=True, default=None, blank=True,
                                       on_delete=models.CASCADE)
